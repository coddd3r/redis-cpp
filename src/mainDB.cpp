...
void MainDB::set(std::vector<std::string> singleCommand, std::string value)
{
    dbValue newVal;
...
const int MainDB::get(const std::string key, int fd)
{
...
int MainDB::getType(std::vector<std::string> singleCommand, int fd)
{
